    ...
    actions: {
        ...
        informationValidate({
            ...
            if (
                ...
                for (const key in state.customerDetails.address) {
                    if (key === "zipCode") {
                        shippingAddress += `<b>zip code:</b> ${state.customerDetails.address[key]}<br/>`;
                        continue;
                    }
                    shippingAddress += `<b>${key}:</b> ${state.customerDetails.address[key]}<br/>`;
                }
